const signUpUser = async (e) => {
    ...
    try {
      const response = await fetch('https://sa-intelbras-back-3.onrender.com/users/signUp', {
        method: 'POST',
        headers: {
  ...
  const loginUser = async (e) => {
    ...
    try {
       ...
       const response = await fetch('https://sa-intelbras-back-3.onrender.com/users/login', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
